...
$report = Join-Path $root 'artifacts/driver-test-v05.txt'
if (-not (Test-Path $exe)) { throw 'Build the test project first.' }
New-Item -ItemType Directory -Force -Path (Split-Path $report) | Out-Null
# The test plan only captures 203.0.113.10 at TCP 443/7443/8443/9443 and UDP 53/443/7444/7445,
...
$arguments = '--driver --report "' + $report + '"'
